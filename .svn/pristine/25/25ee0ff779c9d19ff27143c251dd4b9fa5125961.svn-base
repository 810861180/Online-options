    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <!--<h2 class="brand-info__text">平板管家管理系统</h2>-->
...
export default {
  ...
  methods: {
    ...
    getCaptcha () {
      ...
      this.captchaPath = this.$axios.adornUrl(api.kaptcha() + `?uuid=${this.dataForm.uuid}`)
    }
  }
}
</script>
...
.site-wrapper.site-page--login {
  ...
  &:before {
    ...
    height: 100%;
    content: "";
    background-image: url("~@/../static/images/5bff8401de686.jpg");
