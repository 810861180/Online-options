<template>
  <el-container class='fm2-container'>
          ...
          <div class='components-list'>
            ...
            >
              <li
                ...
                :key='index'
                v-bind:class="item.everUsed ? 'disableLi' : ''"
              >
                <a>
                  <i
                    class='icon iconfont'
    ...
    <!-- <el-footer height='30px'>Powered by
...
export default {
  ...
  mounted () {
    ...
    switch (route) {
      case 'enter-form':
        this.currentArr = commonComponents
        break
      case 'sign-form':
        this.currentArr = Sign
        break
      case 'questionnaire-form':
        this.currentArr = Questionaire
        break
...
.widget-empty {
  background: url("~@/../static/images/form_empty.png") no-repeat;
